...
{
	return [self initWithRegionCode:regionCode bundle:SENDER_FRAMEWORK_BUNDLE];
}

- (id)initWithRegionCodeForTest:(NSString*)regionCode
{
	return [self initWithRegionCodeForTest:regionCode bundle:SENDER_FRAMEWORK_BUNDLE];
}
