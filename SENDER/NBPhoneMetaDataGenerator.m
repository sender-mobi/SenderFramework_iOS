...
{
    NSString *filePath = [SENDER_FRAMEWORK_BUNDLE pathForResource:@"PhoneNumberMetaData" ofType:@"json"];
...
{
    NSString *filePath = [SENDER_FRAMEWORK_BUNDLE pathForResource:@"PhoneNumberMetaDataForTesting" ofType:@"json"];
    return [self parseJSON:filePath];
}
